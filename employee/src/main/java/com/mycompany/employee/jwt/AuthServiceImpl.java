...
public class AuthServiceImpl implements AuthService {
	...
	// Generate JWS token
	@Override
	public GenerateTokenResponse generateJWSToken(GenerateTokenRequest request) throws IOException, JSONException {
	...
	private String populateSubject(GenerateTokenRequest request) throws JSONException {
		  ...
		  JSONObject subjJson = new JSONObject(); subjJson.put("API-KEY",
		  request.getApiKey()); subjJson.put("CUSTOMER-ID", request.getCustomerId());
